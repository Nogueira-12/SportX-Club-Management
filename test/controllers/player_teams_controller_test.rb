...
class PlayerTeamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create player_team" do
    assert_difference("PlayerTeam.count") do
      post player_teams_url, params: { player_team: { club_teams_id: @player_team.club_teams_id, player_profiles_id: @player_team.player_profiles_id } }
    end
  ...
  test "should update player_team" do
    patch player_team_url(@player_team), params: { player_team: { club_teams_id: @player_team.club_teams_id, player_profiles_id: @player_team.player_profiles_id } }
